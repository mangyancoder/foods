            ...
            <div class="cart-table table-responsive bg-gray">
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <?php endif; ?>
                    <?php
                    $pd = new \App\Models\ProductModel;
                    $pc = new \App\Models\PackagesModel;
                    $pcc = $pc->where('pcid', $package)->first();

                    foreach ($product as $p):
                      $pr = $pd->where('pid', $p)->first();
                      ?>
                        ...
                        <tr class="cart__product ">
                          <td class="cart__product-item">
                            ...
                            <div class="cart__product-img">
                              <img src="<?=base_url() . '/' . $pr['picture']?>" alt="product">
                            </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
              <div class="cart__total-amount">
                ...
                <ul class="list-unstyled mb-0">
                  ...
                  <li><h4>Price per Package</h4><h4><?=$pcc['price']?></h4> </li>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-md-12 col-lg-12 cart__product-action-content">
                        ...
                        <form class="d-flex flex-wrap" action="<?=base_url()?>/sbook" method="post"  enctype="multipart/form-data">
                          ...
                          <button class="btn btn__primary" type="button" id="conf" data-price="<?=$tot?>" data-id='<?= $package ?>' data-prod='<?= json_encode($product) ?>'>Confirm</button>
                        </div><!-- /.col-lg-2  -->
                      </div><!-- /.row  -->
                    </td>
                  </tr>
